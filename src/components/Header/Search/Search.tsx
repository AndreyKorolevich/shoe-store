...
const Search = (props) => {
    ...
    return (
        <>
            <button onClick={openForm} aria-label="Save" className={cn('header-controls-pic header-controls-search', {
                'theme': isShowForm,
            })} type='button'/>
            {isShowForm && <form data-id='search-form' className='header-controls-search-form form-inline' onSubmit={handleSubmit}>
